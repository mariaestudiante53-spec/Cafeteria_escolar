...
function ProductosNuevo(){
    ...
    const [nuevoProducto, setNuevoPorudcto] = useState({
        nombre:"",
        descripcion:"",
        precio:"",
        stock:"",
    ...
    const actualizarPorducto = async () => {
        try{
            await API.put(`productos/${editarproducto.id_producto}/`,editarproducto);
    ...
    return(
        <div>
            ...
            <div className="container mt-4">
                ...
                <hr/>
                <button className="btn btn-success mb-3" data-bs-toggle="modal" data-bs-target="#modalProducto">Agregar Producto</button>
                    ...
                    <tbody>
                        {productos.map(producto => (
                            <tr key={producto.id_producto}>
                                ...
                                <td>{producto.activo === 1 ? <span className="badge bg-success">Activo</span>: <span className="badge bg-danger">Inactivo</span>}</td>
                                <td>
                                    ...
                                    <button className="btn btn-danger btn-sm" onClick={() => eliminarProducto(producto.id_producto)}>Eliminar</button>
                                </td>
                            </tr>
                        ))}
                    </tbody>
                    ...
                    <div className="modal-content">
                        ...
                        <div className="modal-body">
                            ...
                            <div className="mb-3">
                                ...
                                onChange={(e) => setNuevoPorudcto({
                                    ...nuevoProducto,stock:e.target.value
                                })}/>
                            </div>
                            <div className="mb-3">
                                ...
                                onChange={(e) => setNuevoPorudcto({
                                    ...nuevoProducto,imagen:e.target.value
                                })}/>
                            </div>
                            <div className="mb-3">
                                ...
                                onChange={(e) => setNuevoPorudcto({
                                    ...nuevoProducto, id_categoria:e.target.value
                                })}>
            ...
            <div className="modal fade" id="modalEditar" tabIndex="-1">
                <div className="modal-dialog modal-lg">
                    <div className="modal-content">
                        ...
                        <div className="modal-body">
                            <div className="mb-3">
                                ...
                                onChange={(e) => setEditarProducto({
                                    ...editarproducto,nombre:e.target.value
                                })}/>
                            </div>
                            <div className="mb-3">
                                <label className="form-label">Descripción</label>
                                ...
                                onChange={(e) => setEditarProducto({
                                    ...editarproducto,descripcion:e.target.value
                                })}/>
                            </div>
                            <div className="mb-3">
                                <label className="form-label">Precio</label>
                                ...
                                onChange={(e) => setEditarProducto({
                                    ...editarproducto,precio:e.target.value
                                })}/>
                            </div>
                            <div className="mb-3">
                                <label className="form-label">Stock</label>
                                ...
                                onChange={(e) => setEditarProducto({
                                    ...editarproducto,stock:e.target.value
                                })}/>
                            </div>
                            <div className="mb-3">
                                <label className="form-label">Imagen</label>
                                ...
                                onChange={(e) => setEditarProducto({
                                    ...editarproducto,imagen:e.target.value
                                })}/>
                            </div>
                            <div className="mb-3">
                                <label className="form-label">Categoria</label>
                                ...
                                onChange={(e) => setEditarProducto({
                                    ...editarproducto, id_categoria:e.target.value
                                })}>
                                    <option value="" >Seleccione una categoría</option>
                                    {categorias.map(categoria =>(
                                        <option key={categoria.id_categoria} value={categoria.id_categoria}>{categoria.nombre}</option>
                        ...
                        <div className="modal-footer">
                            <button className="btn btn-warning" onClick={actualizarPorducto}>Actualizar</button>
                            <button className="btn btn-secondary" data-bs-dismiss="modal">Cancelar</button>
                        </div>
                    </div>
                </div>
